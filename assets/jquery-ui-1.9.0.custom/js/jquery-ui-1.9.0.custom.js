...
$.widget( "ui.autocomplete", {
	...
	_create: function() {
		...
		/**
		 * Modified custom added script
		 */
		if(this.options.appendTo == "body" && this.options.strictAppend === undefined){
			var $fieldset = this.element.parents("fieldset");
			if($fieldset.length!=0){
				this.options.appendTo = $fieldset;
			}
		}
		/**
		 * End of modified custom script
		 */
