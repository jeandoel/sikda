...
class C_pel_trans_kia extends CI_Controller {
	public function index()
	{
		$this->load->helper('beries_helper');
		$this->load->view('pelTranskia/v_pel_trans_kia');
	}
	
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public function pel_trans_kiaxml()
	{		
		$this->load->model('t_pel_trans_kia_model');
		...
		$total = $this->t_pel_trans_kia_model->totalpel_trans_kia($paramstotal);
		...
		$result = $this->t_pel_trans_kia_model->getpel_trans_kia($params);		
