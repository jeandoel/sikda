<?php
class T_ds_gigi_model extends CI_Model {
  ...
  public function getds_gigi($params)
  {
		$this->db->select("k.KELURAHAN,kc.KECAMATAN,u.ID,p.PUSKESMAS,MONTHNAME(STR_TO_DATE(u.BULAN, '%m')) as BULAN,u.TAHUN,u.ID as nid", false );
		$this->db->from('t_ds_gigi u');
  ...
  public function totalds_gigi($params)
  {
