<?php
class T_ds_kegiatanpuskesmas_model extends CI_Model {
  ...
  public function getds_kegiatanpuskesmas($params)
  {
		...
		$this->db->from('t_ds_kegiatanpuskesmas u');
  ...
  public function totalds_kegiatanpuskesmas($params)
  {
