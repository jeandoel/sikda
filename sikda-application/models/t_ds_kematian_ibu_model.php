<?php
class T_ds_kematian_ibu_model extends CI_Model {
  ...
  public function getds_kematian_ibu($params)
  {
		...
		$this->db->from('t_ds_kematian_ibu u');
  ...
  public function totalds_kematian_ibu($params)
  {
