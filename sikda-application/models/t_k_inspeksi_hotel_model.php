<?php
class T_k_inspeksi_hotel_model extends CI_Model {
  ...
  public function getinspeksihotel($params)
  {
		$this->db->select("u.ID,u.NAMA_HOTEL,u.TELP,u.JUMLAH_KARYAWAN,u.TOTAL_NILAI,u.ID as nid", false );
		$this->db->from('t_k_inspeksihotel u');
		...
		if($params['carinama']){
			$this->db->where('u.NAMA_HOTEL like', '%'.$params['carinama'].'%');
		}
  ...
  public function totalinspeksihotel($params)
  {
