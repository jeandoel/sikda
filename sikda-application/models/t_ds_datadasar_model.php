<?php
class T_ds_datadasar_model extends CI_Model {
  ...
  public function getds_datadasar($params)
  {
		$this->db->select("u.ID,k.KELURAHAN,kc.KECAMATAN,p.PUSKESMAS,u.TAHUN,u.ID as nid", false );
		$this->db->from('t_ds_datadasar u');
  ...
  public function totalds_datadasar($params)
  {
