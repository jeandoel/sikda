...
<form name="frApps" id="form1t_imunisasi_add" method="post" action="<?=site_url('t_imunisasi/addprocess')?>" enctype="multipart/form-data">
	<fieldset>
		<span>
		<label>Tanggal</label>
		<input type="text" name="tanggal_imunisasi" id="" class="mydate" value="<?=$TANGGAL?>" />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>Jenis Lokasi</label>
		<input type="text" name="namalokasi" id="namalokasi" value="<?=$KATEGORI_IMUNISASI?>" />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>Nama Lokasi</label>
		<input type="text" name="namalokasi" id="namalokasi" value="<?=$NAMA_LOKASI?>" />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>Alamat</label>
		<textarea name="alamatlokasi" rows="3" cols="30" value="" ><?=$ALAMAT_LOKASI?></textarea>
		</span>
	</fieldset>
	<fieldset>
		<span>
	...
	<fieldset>
		...
		<label>Desa/Kelurahan</label>
			<input type="text" name="kecamatanlokasi" id="kecamatant_imunisasiadd" value="<?=$KELURAHAN?>" />
		</span>
	</fieldset>
	...
	<fieldset>
		...
		<input type="text" name="nama_pasien" id="nama_pasien" value="<?=$NAMA_LENGKAP?>" />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>Tanggal Lahir* (dd/mm/yyyy)</label>
		<input type="text" name="tanggal_lahir" id="" class="mydate" value="<?=$TGL_LAHIR?>" />		
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>Jenis Kelamin</label>
		<input type="text" name="nama_pasien" id="nama_pasien" value="<?=$JENIS_KELAMIN?>" />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>Alamat</label>
		<textarea name="alamatpasien" rows="3" cols="30" value=""><?=$ALAMAT?></textarea>
		</span>
	</fieldset>
	...
	<fieldset>
		...
		<label>Jenis Pasien</label>
			<select name="showhide_jenis_pasien" id="showhide_jenis_pasien_kunjungan">
				<option value="<?=$KD_JENIS_PASIEN?>"><?=$JENIS_PASIEN?></option>
			</select>
		</span>
	</fieldset>
	...
	<fieldset>
		...
		<textarea name="pemeriksaan_fisik" rows="3" cols="23" ><?=$PEMERIKSAAN_FISIK?></textarea>
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>Jenis Imunisasi</label>
		<input type="text" name="nama_pasien" id="nama_pasien" value="<?=$JENIS_IMUNISASI?>" />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>Pemberian Vaksin</label>
		<input type="text" name="nama_pasien" id="nama_pasien" value="<?=$VAKSIN?>" />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>Petugas</label>
		<input type="text" name="nama_pasien" id="nama_pasien" value="<?=$NAMA?>" />
		</span>
	</fieldset>
	<br/>
