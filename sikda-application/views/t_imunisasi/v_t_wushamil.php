...
<script>
	...
	$("#tanggal_hpht").mask("99/99/9999");
</script>

<?=getComboStatusnikah(isset($datasuami->STATUS_MARITAL)?$datasuami->STATUS_MARITAL:'','status_nikah','status_nikaht_imunisasiadd','required','')?>
<fieldset>
	<span>
		<label>Nama Suami</label>
		<input type="text" name="nama_suami" id="nama_suami" value="<?=isset($datasuami->NAMA_SUAMI)?$datasuami->NAMA_SUAMI:''?>" required  />
	</span>
</fieldset>
<fieldset>
	<span>
	<label>HPHT</label>
	<input type="text" name="tanggal_hpht" id="tanggal_hpht" class="mydate" />
	</span>
</fieldset>
<fieldset>
	<span>
		<label>Kehamilan ke</label>
		<input type="text" name="kehamilan_ke" id="kehamilan_ke" value="" required  />
	</span>
</fieldset>
<fieldset>
	<span>
		<label>Jarak Kehamilan (tahun)</label>
		<input type="text" name="jarak_kehamilan" id="jarak_kehamilan" value="" required  />
	</span>
</fieldset>
