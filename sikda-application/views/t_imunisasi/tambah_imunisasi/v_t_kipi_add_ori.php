...
<form name="frApps" id="form1t_imunisasi_kipi" method="post" action="<?=site_url('t_imunisasi_kipi/addprocess')?>" enctype="multipart/form-data">
	<fieldset>
		<span>
	...
	<fieldset>
		...
		<label>Kecamatan</label>
			<select name="kecamatanpasien" id="kecamatant_pendaftaranadd">
				<optionvalue="<?=$KD_KECAMATAN?>">--</option>
			</select>
		</span>
	</fieldset>
	<fieldset>
	...
	<fieldset>
		<span>
			...
			<input type="text" name="" id="" value="<?=date('Y-m-ds')?>" class="mydate" readonly />
		</span>
	</fieldset>
