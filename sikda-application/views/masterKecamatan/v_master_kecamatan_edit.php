...
$(document).ready(function(){
		$('#form1master_kecamatan_edit').ajaxForm({
			beforeSend: function() {
				achtungShowLoader();	
			},
		...
		$('#master_kabupaten_id_hidden').focus(function(){
			...
			$('#dialogcari_master_kabupaten_id').load('c_master_kabupaten/masterkabupatenpopup?id_caller=form1master_kecamatan_edit', function() {
...
<div class="mycontent">
<div class="formtitle">Edit Data Kecamatan</div>
...
<form name="frApps" id="form1master_kecamatan_edit" method="post" action="<?=site_url('c_master_kecamatan/editprocess')?>" enctype="multipart/form-data">
	<fieldset>
		<span>
		<label>Kode Kecamatan</label>
		<input type="text" name="kodekecamatan" id="kodekecamatan" value="<?=$data->KD_KECAMATAN?>" />
		<input type="hidden" name="kodekecamatanid" id="textid" value="<?=$data->KD_KECAMATAN?>" />
		</span>
	</fieldset>
	<fieldset>
		<span>
