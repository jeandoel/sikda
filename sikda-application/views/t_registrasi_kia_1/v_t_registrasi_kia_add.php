...
<div>
	...
	<fieldset>
		...
		<input type="text" name="nama_suami" id="nama_suamit_registrasi_kiaadd" value="" />
		</span>
	</fieldset>	
	<fieldset>
		<span>
		<label>Tempat Lahir</label>
		<input type="text" name="tempat_lahir_suami" id="tempat_lahirt_registrasi_kiaadd" value="" />		
		</span>		
	</fieldset>
	<fieldset>
		<span>
		<label>Tanggal Lahir (dd/mm/yyyy)</label>
		<input type="text" name="tanggal_lahir_suami" id="tanggal_lahirt_registrasi_kiaadd" class="mydate" date/>		
		</span>
		<span>
		-
		<input type="text" name="tahun_usia_suami" id="tahunlahirid_suami" style="width:25px" /> Th
		<input type="text" name="bulan_usia_suami" id="bulanlahirid_suami" style="width:25px" /> Bln
		</span>
	</fieldset>
		<?=getComboAgama('','agama_suami','agamat_registrasi_kiaadd','','')?>			
		<?=getComboGoldarah('','gol_darah_suami','gol_daraht_registrasi_kiaadd','','')?>
		<?=getComboPendidikan('','pendidikan_suami','pendididkant_registrasi_kiaadd','','')?>
		<?=getComboPekerjaan('','pekerjaan_suami','pekerjaant_registrasi_kiaadd','','')?>
	</fieldset>
	<div class="subformtitle">Kunjungan Pemeriksaan</div>	
	<fieldset>
		<span>
		<label>Pilih Kunjungan Pemeriksaan</label>
			<select name="showhide_kunjungan_kia" id="showhide_registrasi_kia_kunjungan" required >
				<option value="">Pilih Jenis Kunjungan Pemeriksaan</option>
				<option value="1">Ibu Hamil</option>
				<option value="2">Ibu Bersalin</option>
				<option value="3">Ibu Nifas</option>
				<option value="4">Ibu KB</option>
			</select>
		</span>
	</fieldset>
</div>
