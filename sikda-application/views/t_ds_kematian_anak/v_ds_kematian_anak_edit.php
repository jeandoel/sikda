...
$(document).ready(function(){
		$('#form1ds_kematian_anakedit').ajaxForm({
			beforeSend: function() {
				achtungShowLoader();	
			},
...
<form name="frApps" id="form1ds_kematian_anakedit" method="post" action="<?=site_url('t_ds_kematian_anak/editprocess')?>">	
	<fieldset>
		<span>
	...
	<?=getComboKecamatanByKab($data->KD_KECAMATAN,'KD_KECAMATAN','kec_id_combo_ds_kematian_anak','required','')?>
	<?=getComboKelurahanByKec($data->KD_KELURAHAN,'KD_KELURAHAN','desa_kel_id_combo_ds_kematian_anak','required','')?>
	<?=getComboPuskesmasByKec($data->KD_PUSKESMAS,'KD_PUSKESMAS','puskesmas_id_combo_ds_kematian_anak','required','')?>
	<fieldset>
		<span>
		<label>Bulan*</label>
	...
	<fieldset>
		<span>
		<label>Tahun*</label>
		<input type="text" name="TAHUN" id="tahun_ds_kematian_anak" value="<?=$data->TAHUN?>" required />
		</span>
	</fieldset>
	</br>
	...
	<fieldset>
		...
		<input type="text" name="JML_L_K_BAYI" value="<?=$data->JML_L_K_BAYI?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>UMUR 0-7 HARI</label>
		<input type="text" name="JML_L_U_0_7_HARI" value="<?=$data->JML_L_U_0_7_HARI?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>UMUR 8-30 HARI</label>
		<input type="text" name="JML_L_U_8_30_HARI" value="<?=$data->JML_L_U_8_30_HARI?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>UMUR 1-12 BULAN</label>
		<input type="text" name="JML_L_U_1_12_BULAN" value="<?=$data->JML_L_U_1_12_BULAN?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>UMUR 1-5 TAHUN</label>
		<input type="text" name="JML_L_U_1_5_TAHUN" value="<?=$data->JML_L_U_1_5_TAHUN?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>PERSALINAN ANAK KE <5</label>
		<input type="text" name="JML_P_PA_KE_KSD_5_L" value="<?=$data->JML_P_PA_KE_KSD_5_L?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>PERSALINAN ANAK KE >5</label>
		<input type="text" name="JML_P_PA_KE_L_5_L" value="<?=$data->JML_P_PA_KE_L_5_L?>"  />
		</span>
	</fieldset>
	</br>
	...
	<fieldset>
		...
		<input type="text" name="JML_P_K_BAYI" value="<?=$data->JML_P_K_BAYI?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>UMUR 0-7 HARI</label>
		<input type="text" name="JML_P_U_0_7_HARI" value="<?=$data->JML_P_U_0_7_HARI?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>UMUR 8-30 HARI</label>
		<input type="text" name="JML_P_U_8_30_HARI" value="<?=$data->JML_P_U_8_30_HARI?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>UMUR 1-12 BULAN</label>
		<input type="text" name="JML_P_U_1_12_BULAN" value="<?=$data->JML_P_U_1_12_BULAN?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>UMUR 1-5 TAHUN</label>
		<input type="text" name="JML_P_U_1_5_TAHUN" value="<?=$data->JML_P_U_1_5_TAHUN?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>PERSALINAN ANAK KE<5</label>
		<input type="text" name="JML_P_PA_KE_KSD_5" value="<?=$data->JML_P_PA_KE_KSD_5?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
	...
	<fieldset>
		...
		<input type="text" name="JML_ANC_KSD_4" value="<?=$data->JML_ANC_KSD_4?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>ANC KE>4</label>
		<input type="text" name="JML_ANC_L_4" value="<?=$data->JML_ANC_L_4?>"  />
		</span>
	</fieldset>
	</br>
	...
	<fieldset>
		<span>
		<label>BCG</label>
		<input type="text" name="JML_SI_BCG" value="<?=$data->JML_SI_BCG?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>DPT</label>
		<input type="text" name="JML_SI_DPT" value="<?=$data->JML_SI_DPT?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>POLIO</label>
		<input type="text" name="JML_SI_POLIO" value="<?=$data->JML_SI_POLIO?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>CAMPAK</label>
		<input type="text" name="JML_SI_CAMPAK" value="<?=$data->JML_SI_CAMPAK?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>HB</label>
		<input type="text" name="JML_SI_HB" value="<?=$data->JML_SI_HB?>"  />
		</span>
	</fieldset>
	</br>
	...
	<fieldset>
		...
		<input type="text" name="JML_SK_TN" value="<?=$data->JML_SK_TN?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>BBLR</label>
		<input type="text" name="JML_SK_BBLR" value="<?=$data->JML_SK_BBLR?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>ASFEKSIA</label>
		<input type="text" name="JML_SK_ASFEKSIA" value="<?=$data->JML_SK_ASFEKSIA?>"  />
		</span>
	</fieldset><fieldset>
		<span>
	...
	<fieldset>
		<span>
		<label>RUMAH</label>
		<input type="text" name="JML_TK_RUMAH" value="<?=$data->JML_TK_RUMAH?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>PUSKESMAS/RB</label>
		<input type="text" name="JML_TK_PUSKESMAS_RB" value="<?=$data->JML_TK_PUSKESMAS_RB?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>RUMAH SAKIT</label>
		<input type="text" name="JML_TK_RS" value="<?=$data->JML_TK_RS?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>PERJALANAN</label>
		<input type="text" name="JML_TK_PERJALANAN" value="<?=$data->JML_TK_PERJALANAN?>"  />
		</span>
	</fieldset>
	</br>
	...
	<fieldset>
		<span>
		<label>DUKUN</label>
		<input type="text" name="JML_PP_DUKUN" value="<?=$data->JML_PP_DUKUN?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>BIDAN</label>
		<input type="text"  name="JML_PP_BIDAN" value="<?=$data->JML_PP_BIDAN?>"  />
		</span>
	</fieldset>
	<fieldset>
		<span>
