...
$('#popupkunjungan_hidden').focus(function(){
			...
			$('#dialogtransaksi_cari_kunjungan_nifas').load('t_kunjungan_nifas/masterkunjungannifaspopup?id_caller=kunjungannifasadd', function() {
...
<div class="mycontent">
<div class="formtitle">Pelayanan Kunjungan Ibu</div>
...
<form name="frApps" id="kunjungannifasadd" method="post" action="<?=site_url('t_kunjungan_nifas/addprocess')?>" enctype="multipart/form-data">
	<fieldset>
		...
		<input type="text" name="kd_puskesmas" id="kd_puskesmas" value="Otomatis" disabled  />		
		</span>	
		<span>
		<label>Nik</label>
		<input type="text" name="nik" id="nik" value="Otomatis" disabled  />		
		</span>	
	</fieldset>
	<fieldset>
		<span>
		<label>Nama Pasien</label>
		<input type="text" name="nama_lengkap" id="nama_lengkap" value="Otomatis" disabled  />		
		</span>
		<span>
		<label>Golongan Darah</label>
		<input type="text" name="gol_darah" id="gol_darah" value="Otomatis" disabled  />		
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>Jenis Pasien</label>
		<input type="text" name="jenis_pasien" id="jenis_pasien" value="Otomatis" disabled  />		
		</span>
		<span>
		<label>Tanggal Lahir</label>
		<input type="text" name="tanggal_lahir" id="tanggal_lahir" value="Otomatis" disabled  />		
		</span>
	</fieldset>
	...
	<fieldset>
		...
		<input type="text" name="nama_ayah" id="nama_ayah" value="Otomatis" disabled  />		
		</span>
		<span>
		<label>Jenis Kunjungan</label>
		<input type="text" name="jenis_kunjungan" id="jenis_kunjungan" value="Otomatis" disabled  />		
		</span>
	</fieldset>
	<fieldset>
		<span>
