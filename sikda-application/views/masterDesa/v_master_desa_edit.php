		...
		$('#formdesamasterdesaedit').ajaxForm({
			...
			complete: function(xhr) {
				...
				if(xhr.responseText!=='OK'){
					...
					$("#t19","#tabs").empty();
					$("#t19","#tabs").load('c_master_desa'+'?_=' + (new Date()).getTime());
				}
			}
		});
})
...
<form name="frApps" id="formdesamasterdesaedit" method="post" action="<?=site_url('c_master_desa/editprocess')?>" enctype="multipart/form-data">
	<fieldset>
		<span>
