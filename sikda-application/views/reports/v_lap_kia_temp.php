...
<table width="1500" border="1">
  ...
  <tr>
    ...
    <td><?php $JML_KJ_N_BR_0_7HARI_KN1_TEMP=$row['JML_KJ_N_BR_0_7HARI_KN1']+$row['JML_KJ_N_BR_0_7HARI_KN1_p'];$JML_KJ_N_BR_0_7HARI_KN1=$JML_KJ_N_BR_0_7HARI_KN1+$JML_KJ_N_BR_0_7HARI_KN1_TEMP; echo $JML_KJ_N_BR_0_7HARI_KN1_TEMP?></td>
    <td><?php $JML_KJ_N_BR_8_28HARI_KN2_TEMP=$row['JML_KJ_N_BR_8_28HARI_KN2']+$row['JML_KJ_N_BR_8_28HARI_KN2_p'];$JML_KJ_N_BR_8_28HARI_KN2=$JML_KJ_N_BR_8_28HARI_KN2+$JML_KJ_N_BR_8_28HARI_KN2_TEMP; echo $JML_KJ_N_BR_8_28HARI_KN2_TEMP?></td>
    ...
    <td><?php $B_N_L_MATI_TEMP=$row['B_N_L_MATI']+$row['B_N_L_MATI_p'];$B_N_L_MATI=$B_N_L_MATI+$B_N_L_MATI_TEMP; echo $B_N_L_MATI_TEMP?></td>
    <td><?php $B_N_L_HIDUP_TEMP=$row['B_N_L_HIDUP']+$row['B_N_L_HIDUP_p'];$B_N_L_HIDUP=$B_N_L_HIDUP+$B_N_L_HIDUP_TEMP; echo $B_N_L_HIDUP_TEMP?></td>
    <td><?php $K_B_N_UMR_0_7_HARI_TEMP=$row['K_B_N_UMR_0_7_HARI']+$row['K_B_N_UMR_0_7_HARI_p'];$K_B_N_UMR_0_7_HARI=$K_B_N_UMR_0_7_HARI+$K_B_N_UMR_0_7_HARI_TEMP; echo $K_B_N_UMR_0_7_HARI_TEMP?></td>
    <td><?php $K_B_N_UMR_8HR_1BL_TEMP=$row['K_B_N_UMR_8HR_1BL']+$row['K_B_N_UMR_8HR_1BL_p'];$K_B_N_UMR_8HR_1BL=$K_B_N_UMR_8HR_1BL+$K_B_N_UMR_8HR_1BL_TEMP; echo $K_B_N_UMR_8HR_1BL_TEMP?></td>
    <td><?php $K_B_N_UMR_1BL_1THN_TEMP=$row['K_B_N_UMR_1BL_1THN']+$row['K_B_N_UMR_1BL_1THN_p'];$K_B_N_UMR_1BL_1THN=$K_B_N_UMR_1BL_1THN+$K_B_N_UMR_1BL_1THN_TEMP; echo $K_B_N_UMR_1BL_1THN_TEMP?></td>
    <td>0</td>
  </tr>
  <?php
	$no++;
...
<table width="1500" border="1">
  ...
  <tr>
   ...
   <?php
	$no=1;
	$B_N_D_BBL_2500_3000GR=0;
	$JML_B_N_D_BBL_L_3000GR=0;
	$JML_B_N_BBL_K_2500GR=0;
	$JML_BBLR_N_D_T_KESEHATAN=0;
  ...
  <tr>
    <td><div align="center"><?=$no;?></div></td>
    <td><?=$row['PUSKESMAS'];?></td>
    <td><?php $B_N_D_BBL_2500_3000GR_TEMP=$row['B_N_D_BBL_2500_3000GR']+$row['B_N_D_BBL_2500_3000GR_p'];$B_N_D_BBL_2500_3000GR=$B_N_D_BBL_2500_3000GR+$B_N_D_BBL_2500_3000GR_TEMP; echo $B_N_D_BBL_2500_3000GR_TEMP?></td>
    <td><?php $JML_B_N_D_BBL_L_3000GR_TEMP=$row['JML_B_N_D_BBL_L_3000GR']+$row['JML_B_N_D_BBL_L_3000GR_p'];$JML_B_N_D_BBL_L_3000GR=$JML_B_N_D_BBL_L_3000GR+$JML_B_N_D_BBL_L_3000GR_TEMP; echo $JML_B_N_D_BBL_L_3000GR_TEMP?></td>
    <td><?php $JML_B_N_BBL_K_2500GR_TEMP=$row['JML_B_N_BBL_K_2500GR']+$row['JML_B_N_BBL_K_2500GR_p'];$JML_B_N_BBL_K_2500GR=$JML_B_N_BBL_K_2500GR+$JML_B_N_BBL_K_2500GR_TEMP; echo $JML_B_N_BBL_K_2500GR_TEMP?></td>
    <td><?php $JML_BBLR_N_D_T_KESEHATAN_TEMP=$row['JML_BBLR_N_D_T_KESEHATAN']+$row['JML_BBLR_N_D_T_KESEHATAN_p'];$JML_BBLR_N_D_T_KESEHATAN=$JML_BBLR_N_D_T_KESEHATAN+$JML_BBLR_N_D_T_KESEHATAN_TEMP; echo $JML_BBLR_N_D_T_KESEHATAN_TEMP?></td>
    ...
    <td><?php $N_RESTI_TEMP=$row['N_RESTI']+$row['N_RESTI_p'];$N_RESTI=$N_RESTI+$N_RESTI_TEMP; echo $N_RESTI_TEMP?></td>
    <td><?php $N_R_DRJ_PUSKESMAS_TEMP=$row['N_R_DRJ_PUSKESMAS']+$row['N_R_DRJ_PUSKESMAS_p'];$N_R_DRJ_PUSKESMAS=$N_R_DRJ_PUSKESMAS+$N_R_DRJ_PUSKESMAS_TEMP; echo $N_R_DRJ_PUSKESMAS_TEMP?></td>
    <td><?php $N_R_DRJ_RS_TEMP=$row['N_R_DRJ_RS']+$row['N_R_DRJ_RS_p'];$N_R_DRJ_RS=$N_R_DRJ_RS+$N_R_DRJ_RS_TEMP; echo $N_R_DRJ_RS_TEMP?></td>
    <td><?php $B_N_YG_DTK_TBH_KEMBANGNYA_TEMP=$row['B_N_YG_DTK_TBH_KEMBANGNYA']+$row['B_N_YG_DTK_TBH_KEMBANGNYA_p'];$B_N_YG_DTK_TBH_KEMBANGNYA=$B_N_YG_DTK_TBH_KEMBANGNYA+$B_N_YG_DTK_TBH_KEMBANGNYA_TEMP; echo $B_N_YG_DTK_TBH_KEMBANGNYA_TEMP?></td>
    <td><?php $A_N_D_KLN_TBH_KEMBANG_TEMP=$row['A_N_D_KLN_TBH_KEMBANG']+$row['A_N_D_KLN_TBH_KEMBANG_p'];$A_N_D_KLN_TBH_KEMBANG=$A_N_D_KLN_TBH_KEMBANG+$A_N_D_KLN_TBH_KEMBANG_TEMP; echo $A_N_D_KLN_TBH_KEMBANG_TEMP?></td>
    <td><?php $JML_KJ_TK_ADA_TEMP=$row['JML_KJ_TK_ADA']+$row['JML_KJ_TK_ADA_p'];$JML_KJ_TK_ADA=$JML_KJ_TK_ADA+$JML_KJ_TK_ADA_TEMP; echo $JML_KJ_TK_ADA_TEMP?></td>
    <td><?php $JML_KJ_TK_DIKUNJUNGI_TEMP=$row['JML_KJ_TK_DIKUNJUNGI']+$row['JML_KJ_TK_DIKUNJUNGI_p'];$JML_KJ_TK_DIKUNJUNGI=$JML_KJ_TK_DIKUNJUNGI+$JML_KJ_TK_DIKUNJUNGI_TEMP; echo $JML_KJ_TK_DIKUNJUNGI_TEMP?></td>
  ...
  <tr>
    <td colspan="2"><div align="center">JUMLAH</div></td>
    <td><?=$B_N_D_BBL_2500_3000GR?></td>
    <td><?=$JML_B_N_D_BBL_L_3000GR?></td>
    <td><?=$JML_B_N_BBL_K_2500GR?></td>
    <td><?=$JML_BBLR_N_D_T_KESEHATAN?></td>
