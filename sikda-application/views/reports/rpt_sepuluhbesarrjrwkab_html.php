...
<div class="content">
	...
	<thead>
		<tr>	
			<th rowspan="3">No</th>
			<th rowspan="3" width="500px">PUSKESMAS</th>
			<th colspan="<?=10*3?>">10 Penyakit dan Jumlah Kasus</th>
		</tr>
		
		<tr>	
			<?$limit=1;foreach($result['RJ']['OBAT'] as $key=>$row){if($limit == 11) break;?>		
	...
	<tbody>
		...
		<tr>
			<td align="center" colspan="2">KABUPATEN</td>
	...
	<thead>
		...
		<tr>	
			<?$limit=1;foreach($result['RI']['OBAT'] as $key=>$row){if($limit == 11) break;?>		
			<th rowspan="2">Nama Penyakit</th>
			<th colspan="2">Jumlah Kasus</th>
			<?$limit++;}?>
		</tr>
