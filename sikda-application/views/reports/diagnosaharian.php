...
$('document').ready(function(){	
	...
	$("#excelhrj").click(function(event){
		...
		var pid = $('#idphrj').val();
		var jenislk = $('#jenislk').val();
		window.open('<?=base_url().'report_harian/lap_diagnosa?from='?>'+decodeURIComponent(from)+'&to='+decodeURIComponent(to)+'&pid='+decodeURIComponent(pid)+'&jenis='+decodeURIComponent(jenislk));
	});
})
</script>
<style>
...
<div class="mycontent">
<div class="formtitle">Laporan Diagnosa Harian</div>
