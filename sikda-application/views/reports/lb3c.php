...
$('document').ready(function(){
	...
	$("#excellb3").click(function(event){
		...
		var pid = $('#idplb3').val();
		var jenis = $('#jenislb3').val();
		NewWin = window.open('<?=base_url().'report_bulanan/lb3c_excel_update?from='?>'+decodeURIComponent(from)+'&to='+decodeURIComponent(to)+'&pid='+decodeURIComponent(pid)+'&jenis='+decodeURIComponent(jenis));
...
<div class="mycontent">
<div class="formtitle">Laporan Bulanan IMUNISASI (LB3c)</div>
