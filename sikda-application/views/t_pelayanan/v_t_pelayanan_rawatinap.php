...
$(document).ready(function(){
		...
		$('#tambahobatid').click(function(){
			if($('#obat_tmpval').val()){
				var myfirstrow = {kd_obat:$('#obat_tmpval').val(), obat:$('#obat_tmptext').val(), dosis:$('#dosisobatid').val(), jumlah:$('#kuantitasobatid').val(), satuan:$('#satuan_obatid').val(), harga:$('#hargaobattmpid').val()};
...
<div class="formtitle">Pelayanan Rawat Inap</div>
</br>
