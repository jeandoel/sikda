...
jQuery().ready(function (){ 
	jQuery("#listpemeriksaanneonatuspopup").jqGrid({ 
		...
		datatype: "xml", 					
		colNames:['KD PEMERIKSAAN NEONATUS','KD PEMERIKSAAN NEONATUS','KD PUSKESMAS','Tanggal Pemeriksaan','Kunjungan ke','Berat Badan (kg)','Panjang Badan (cm)','Memeriksa Bayi/Anah','Keterangan','Tindakan Ibu','Keluhan','Pemeriksa','Petugas'],
		rownumbers:true,
		width: 1021,
		height: 'auto',
		mtype: 'POST',
		...
		colModel:[  
			...
			beforeRequest:function(){
				...
				get_kd_pasien=$('#get_kd_pasien_neo').val()?$('#get_kd_pasien_neo').val():'';
				$('#listpemeriksaanneonatuspopup').setGridParam({postData:{'dari':'','sampai':'','carinama':carinama, 'get_kd_pasien':get_kd_pasien}})
			}
...
<div>
	<input type="hidden" name="get_kd_pasien_neo" id="get_kd_pasien_neo" value="<?php echo $get_kd_pasien?>">
</div>
<div class="mycontent">
