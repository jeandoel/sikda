	...
	jQuery("#listt_kunjungan_nifaspopup").jqGrid({ 
		...
		colModel:[ 
			...
			beforeRequest:function(){
				get_kd_pasien=$('#get_kd_pasien_nifas').val()?$('#get_kd_pasien_nifas').val():'';
				$('#listt_kunjungan_nifaspopup').setGridParam({postData:{'get_kd_pasien':get_kd_pasien}})
			}
...
<div>
	<input type="hidden" name="get_kd_pasien_nifas" id="get_kd_pasien_nifas" value="<?php echo $get_kd_pasien;?>">
</div>
<div class="mycontent">
