	...
	jQuery("#listusatuankecilpopup").jqGrid({ 
		...
		colModel:[
			...
			beforeRequest:function(){
				...
				$('#listusatuankecilpopup').setGridParam({postData:{'dari':'','sampai':'','kdsatkclobat':kdsatkclobat}})
			}
	...
	<form id="formsatuankecilpopup">
		...
		<fieldset style="margin:0 13px 0 13px ">
			<span>
				...
				<input type="text" name="kdsatkclobat" class="nama" id="satuankecil_mastersatuanpopup"/>
			</span>
			<span>
