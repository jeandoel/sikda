...
$(document).ready(function(){
		$('#formgigi_map_gigiedit').ajaxForm({
			beforeSend: function() {
				achtungShowLoader();	
			},
...
<div class="mycontent">
<div class="formtitle">Edit Gambar Permukaan Gigi</div>
<div class="backbutton"><span class="kembali" id="backlist_map_gigi">kembali ke list</span></div>
</br>

<span id='errormsg'></span>
<form name="frApps" id="formgigi_map_gigiedit" method="post" action="<?=site_url('c_map_gigi_permukaan/editprocess')?>" enctype="multipart/form-data">
	<input type="hidden" name="kd" id="kd" value="<?php echo $data->ID?>">
	<div id="gigi_permukaan_pop">
		...
		<fieldset>
			<span>
				...
				<input type="text" name="kode_id" id="kode_id" style="width:50px;font-size:12px;" value="<?php echo $data->KODE;?>" tabindex="3" />
	...
	<div id="gigi_status_pop">
		...
		<fieldset>
			<span>
				...
				<input type="hidden" name="id_status_gigi" id="master_id_status_gigi" style="width:50px;font-size:12px;" value="<?php echo $data->ID_STATUS_GIGI?>" tabindex="3" />
				<input type="text" name="kd_status_gigi" id="master_gigi_status_id_hidden" style="width:50px;font-size:12px;" value="<?php echo $data->KD_STATUS_GIGI?>" tabindex="3" />
