...
<form name="frApps" id="form1t_pendaftaranpelayanan" method="post" onsubmit="bt1.disabled = true; return true;" action="<?=site_url('t_pendaftaran/daftarkunjunganprocess')?>" enctype="multipart/form-data">
	<fieldset>
		<span>
		<label>Rekam Medis#</label>
		<input type="text" name="text" value="<?=$data->KD_PASIEN?>" disabled />
		<input type="hidden" name="kd_pasien_hidden" id="textid222" value="<?=$data->KD_PASIEN?>" />
