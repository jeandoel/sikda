...
<div class="mycontent">
<div class="formtitle">Detail Data Dasar</div>
...
<form name="frApps" method="post" enctype="multipart/form-data">
	...
	<fieldset>
		...
		<input type="text" readonly  style="width:195px!important" name="TAHUN" id="tahun_ds_datadasar" value="<?=$data->KELURAHAN?>" required />
		</span>
	</fieldset>
	<fieldset>
		<span>
		<label>Puskesmas</label>
		<input type="text" readonly  style="width:195px!important" name="TAHUN" id="tahun_ds_datadasar" value="<?=$data->PUSKESMAS?>" required />
		</span>
	</fieldset>
	<!--<fieldset>
		<span>
	...
	<fieldset>
		<span>
		<label>Tahun</label>
		<input type="text" readonly  name="TAHUN" id="tahun_ds_datadasar" value="<?=$data->TAHUN?>" required />
		</span>
	</fieldset>
	</br>
