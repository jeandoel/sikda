...
$(document).ready(function(){
		$('#formmastericd').ajaxForm({
			...
			$('#dialog_cari_namaicdinduk').load('c_master_icd_induk/icdindukpopup?id_caller=formmastericd', function() {
...
<form name="frApps" id="formmastericd" method="post" action="<?=site_url('c_master_icd/addprocess')?>" enctype="multipart/form-data">
	...
	<fieldset>
		...
		<input type="text" name="kode_icd_induk" id="nama_icdinduk_hidden" value=""  />
